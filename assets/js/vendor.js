    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _i23 = 0; _i23 < e.length; _i23 += 1) {
          ...
          var _u5 = "translate3d(".concat(_c5, "px, ").concat(_p3, "px, 0px) rotateX(").concat(_d5, "deg) rotateY(").concat(_o8, "deg)");
          se(a, _r13).transform(_u5);
        }
      },
      setTransition: function setTransition(e) {
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e85 = 0, _t53 = a.length; _e85 < _t53; _e85 += 1) {
          ...
          Math.abs(_v2) < .001 && (_v2 = 0), Math.abs(_g2) < .001 && (_g2 = 0), Math.abs(_m2) < .001 && (_m2 = 0), Math.abs(_u6) < .001 && (_u6 = 0), Math.abs(_h3) < .001 && (_h3 = 0), Math.abs(_w) < .001 && (_w = 0);
          var _b = "translate3d(".concat(_v2, "px,").concat(_g2, "px,").concat(_m2, "px)  rotateX(").concat(_h3, "deg) rotateY(").concat(_u6, "deg) scale(").concat(_w, ")");
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _l10 = 0; _l10 < e.length; _l10 += 1) {
          ...
          if (_u7 = _c6 < 0 ? "calc(".concat(_u7, "px + (").concat(_v3 * Math.abs(_c6), "%))") : _c6 > 0 ? "calc(".concat(_u7, "px + (-").concat(_v3 * Math.abs(_c6), "%))") : "".concat(_u7, "px"), !t.isHorizontal()) {
            var _e90 = _h4;
            _h4 = _u7, _u7 = _e90;
          }
          var _y = _c6 < 0 ? "" + (1 + (1 - _f4) * _c6) : "" + (1 - (1 - _f4) * _c6),
            _E = "\n        translate3d(".concat(_u7, ", ").concat(_h4, ", ").concat(_m3, "px)\n        rotateZ(").concat(a.rotate ? _g3 : 0, "deg)\n        scale(").concat(_y, ")\n      ");
          if (a.slideShadows) {
