 ...
 * @return {Object} - this
 */
function _fpcconcordColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_fpcconcordColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_fpcconcordColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_fpcconcordColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _fpcconcordColor object.
 *
 * @since Twenty Twenty 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function fpcconcordColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _fpcconcordColor( backgroundColor, accentHue );
